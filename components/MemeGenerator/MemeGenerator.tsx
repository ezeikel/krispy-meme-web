        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            ...
            <Button
              ...
              variant="default"
            >
              <FontAwesomeIcon icon={faDownload} className="size-4 mr-2" />{' '}
              Download
            </Button>
            <Button onClick={handleReset} variant="outline">
              <FontAwesomeIcon icon={faArrowsRotate} className="size-4 mr-2" />{' '}
              Reset
            </Button>
          </div>
        </div>
            ...
            {textBoxes.length > 0 ? (
              <>
                ...
                {selectedTextBoxId && (
                  <TextEditor
                    textBox={
                      textBoxes.find((box) => box.id === selectedTextBoxId)!
                    }
                    onUpdate={(updates) =>
              ...
              <div className="flex flex-col items-center justify-center py-8">
                ...
                <Button onClick={handleAddTextBox}>
                  <FontAwesomeIcon icon={faPlus} className="size-4 mr-2" /> Add
                  Text
                </Button>
              </div>
            )}
